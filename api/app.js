...
/*
var privateKey  = fs.readFileSync('/etc/letsencrypt/live/fishfarm.starsknights.com/privkey.pem', 'utf8');
var certificate = fs.readFileSync('/etc/letsencrypt/live/fishfarm.starsknights.com/fullchain.pem', 'utf8');
