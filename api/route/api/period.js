...
router.put('/:id',verifyTokenAndAdmin,async (req,res)=>{
    try{
        ...
        if(req.body.isEnd) req.body.end_Date = new Date()
...
router.get('/query',async (req,res)=>{
    try{
        ...
        if(req.query.new){
            ...
            periods = await Period.find(filter,{'_id':0,'createdAt':0,'__v':0})
        ...
        //QUERY BY PERIOD ID
            ...
            periods = await Period.find({periodId: req.query.periodid},{'_id':0,'createdAt':0,'__v':0})
                                .populate('fishpond',{fishpondId : 1 ,_id : 0})
                                .populate('fishtype',{fishtype : 1 ,_id : 0})
