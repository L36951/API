...
router.get('/queryend/aver',verifyTokenAndAdmin,async(req,res)=>{
    ...
    //Get all sensortype
    const sensortypes = await Sensortype.find({},{'sensortype':1})
    ...
    for(let i=0;i<periods.length;i++){ 
        ...
        tempArray.push({sensortype:'start_quantity',value : periods[i].start_quantity})
        tempArray.push({sensortype:'end_quantity',value : periods[i].end_quantity})
